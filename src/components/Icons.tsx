...
export const PaintIcon: React.FC<IconProps> = ({ size = 16, color = 'currentColor', className }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
    ...
    className={className}
  >
    <path d="M12 2a10 10 0 0 0-9.95 9h11.64L9.74 7.22a1 1 0 0 1 1.41-1.41l3.93 3.93a1 1 0 0 1 0 1.42l-3.93 3.93a1 1 0 0 1-1.41-1.41l3.95-3.95H2.05A10 10 0 1 0 12 2z"></path>
